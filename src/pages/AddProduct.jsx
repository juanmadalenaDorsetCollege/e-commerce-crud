...
export default function AddProduct() {
    ...
    const handleAddProduct = async () => {
        ...
        try{
            await productServices.addProduct({title, brand, category, description, price, discountPercentage, stock, thumbnail, images, rating})
            getProducts(true)
            navigate('/')
    ...
    return (
        <section className='flex items-center justify-center flex-col'>
            <h1 className="text-3xl font-semibold text-center">New Product</h1>
            <div className="w-2/3 min-w-96 mt-3 py-8 bg-neutral-100 rounded-lg flex items-center justify-center flex-col">
                <div className="w-[80%]">
                    ...
                    <button className="w-full p-3 rounded-md border bg-neutral-300 hover:bg-neutral-400" onClick={handleAddProduct}>
